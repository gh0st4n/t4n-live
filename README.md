...
* [*t4n-rootfs.sh*](#t4n-rootfs) - The Void Linux rootfs generator for all platforms
* [*t4n-platformfs.sh*](#t4n-platformfs) - The Void Linux filesystem tool to produce
  a rootfs for a particular platform
* [*t4n-image.sh*](#t4n-image) - The Void Linux image generator for ARM platforms
* [*t4n-net.sh*](#t4n-net) - Script to generate netboot tarballs for Void
...
Use [*t4n-rootfs.sh*](#t4n-rootfs) to generate a Void Linux ROOTFS.
...
[*t4n-platformfs.sh*](#t4n-platformfs) to generate a Void Linux PLATFORMFS.
...
then use [*t4n-image.sh*](#t4n-image) to generate the image.
